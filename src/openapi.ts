...
const generationRequestSchema = {
  ...
  properties: {
    ...
    llm_image_prompt_guidance: { type: 'string' },
    llmImagePromptGuidance: { type: 'string' },
...
const favoriteImagePromptSchema = {
  ...
  properties: {
    ...
    llmImagePromptGuidance: { oneOf: [{ type: 'string' }, { type: 'null' }] },
    promptPreview: { type: 'string' },
    negativePromptPreview: { oneOf: [{ type: 'string' }, { type: 'null' }] },
    llmImagePromptGuidancePreview: { oneOf: [{ type: 'string' }, { type: 'null' }] },
...
const jobSchema = {
  ...
  properties: {
    ...
    cancelRequestedAt: { oneOf: [{ type: 'string' }, { type: 'null' }] },
    canceledAt: { oneOf: [{ type: 'string' }, { type: 'null' }] },
    cancellationReason: { oneOf: [{ type: 'string' }, { type: 'null' }] },
